...
const MARKERS: Array<[RegExp, string, number]> = [
  ...
  [
    /\bà\b|\b(?:nouveau|nouveaux|nouvelle|jours|prêt|selon|mercato)\b/i,
    "fr",
    3,
  ],
  [
    /\b(?:amichevole|infortunio|attaccante|difensore|centrocampista|ultime|verso)\b/i,
    "it",
    3,
  ],
  ...
  [
    /\b(?:della|delle|nella|dello|sulla|degli|dalla|agli|alle|allo|nei)\b/i,
    "it",
    3,
  ],
  ...
  [
    /\b(?:per|si|ci|non|che|lo|gli|questo|questa|queste|dopo|verso)\b/i,
    "it",
    2,
  ],
  [
    /\b(?:tifosi|partita|scudetto|prestito|dichiarazioni|conferenza|panchina|azzurri)\b/i,
    "it",
    3,
  ],
  [
    /\b(?:qui|dont|aux|leur|être|est|sont|était|ont|cette|ces|dans|pour|avec)\b/i,
    "fr",
    3,
  ],
  [
    /\b(?:mercato|recrue|transfert|entraîneur|effectif|milieu|attaquant|défenseur)\b/i,
    "fr",
    3,
  ],
  [
    /\b(?:vers|chez|depuis|toujours|encore|aussi|déjà|très|après|avant)\b/i,
    "fr",
    3,
  ],
 ...
 */
const ELISION =
  /\b(?:qu|c|n|j|m|t|l|d|dell|nell|sull|all|dall|un)['’](?=[a-zà-ÿ])/i;
